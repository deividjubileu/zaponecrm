...
<footer class="footer footer-static footer-light navbar-border navbar-shadow">
      <div style='color:<?= $color_background; ?>' class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">2025  &copy; Copyright <a class="text-bold-800 grey darken-2" href="<?= $external_link; ?>" target="_blank"><?= $website_name; ?></a></span>
        <ul class="list-inline float-md-right d-block d-md-inline-blockd-none d-lg-block mb-0">
          ...
          <li style='color:<?= $color_background; ?>' class="list-inline-item"><a class="my-1" href="https://digitalavance.com.br/" target="_blank">Desenvolvido por Digital Avance</a></li>
          <li style='color:<?= $color_background; ?>' class="list-inline-item"><a class="my-1" href="https://wa.me/5581995511599" target="_blank">Contato: (81) 99551-1599</a></li>
        </ul>
      </div>
    </footer>